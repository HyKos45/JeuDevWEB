<?php
    ...
    echo "<div class='health-bar-progress " . getHealthClass($row['current_health'], $row['max_health']) . "' style='width: " . ($row['current_health'] / $row['max_health'] * 100) . "%'></div>";
    echo "</div>";

    function getHealthClass($current_health, $max_health) {
    $percentage = $pdv / $max_health * 100;
